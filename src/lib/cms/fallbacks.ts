...
export const fallbackCMSContent: Record<string, any> = {
  home: {
    ...
    sponsors: {
      title_en: "Supported By",
      title_bn: "পৃষ্ঠপোষকতায়",
      logos: [
        { name: "Cultural Ministry", url: "https://images.unsplash.com/photo-1599305445671-ac291c95aaa9?w=200&h=100&fit=crop" },
        { name: "Local Arts Council", url: "https://images.unsplash.com/photo-1599305445671-ac291c95aaa9?w=200&h=100&fit=crop" }
      ]
    },
    testimonials: {
      ...
      items: [
        {
          ...
          author: "Anindita Ray",
          role_en: "Art Critic",
          role_bn: "শিল্প সমালোচক"
        },
        {
          quote_en: "The annual exhibition is an unmissable event that beautifully captures the spirit of our times.",
          quote_bn: "বার্ষিক প্রদর্শনী একটি অবশ্য দ্রষ্টব্য ইভেন্ট যা আমাদের সময়ের চেতনাকে সুন্দরভাবে ক্যাপচার করে।",
    ...
    contactCTA: {
      title_en: "Join Our Artistic Journey",
      title_bn: "আমাদের শৈল্পিক যাত্রায় যোগ দিন",
      description_en: "Subscribe to our newsletter to receive updates on upcoming exhibitions and artist spotlights.",
      description_bn: "আসন্ন প্রদর্শনী এবং শিল্পীদের সম্পর্কে আপডেট পেতে আমাদের নিউজলেটার সাবস্ক্রাইব করুন।"
    }
  },
  contact: {
    hero: {
      ...
      subtitle_en: "We would love to hear from you. Visit us at the Silva Tirtha Art Gallery.",
      subtitle_bn: "আমরা আপনার কাছ থেকে শুনতে চাই। সিলভা তীর্থ আর্ট গ্যালারিতে আমাদের সাথে দেখা করুন।"
    },
    info: {
