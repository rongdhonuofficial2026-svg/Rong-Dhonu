        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8 mb-20">
          ...
          <div className="lg:col-span-4 flex flex-col space-y-8">
            ...
            <p className="text-white/60 font-light leading-relaxed max-w-sm">
              Cultivating contemporary art and preserving cultural heritage through annual exhibitions, fostering a thriving ecosystem for artists and appreciators alike.
            </p>
            <div className="flex flex-col space-y-3 text-sm text-white/50 font-light">
              <span className="flex items-center gap-3">
                <MapPin className="w-4 h-4 text-[#D4AF37]" />
                Silva Tirtha Art Gallery, Berhampore
              </span>
              <span className="flex items-center gap-3">
                <Mail className="w-4 h-4 text-[#D4AF37]" />
                contact@rongdhono.org
              </span>
            </div>
          </div>
